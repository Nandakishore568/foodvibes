...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">Food Vibes</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-6">
	<div class="container-fluid">
	 <img src="img/images (1).jpg" height="300px" width="100%">
	</div>
	 <div class="container">
	 <p style="font-family: 'Lobster', cursive; font-weight:light;  font-size:25px;">With the online food delivery in place, you can be available to the remote food-lovers by being visible with your restaurant menu and giving the option to deliver in their area.</p>
	 </div>
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	   ...
	   <div class="col-sm-6">
	        <div class="container-fluid">
	             <img src="img/9c935e14be80fcfa4233736a7d3d5a26.jpg" height="300px" width="100%"><!--image-->
	        </div>
	        <div class="container">
	        <!--paragraph content--> 
	             <p style="font-family: 'Lobster', cursive; font-weight:light; font-size:25px;">food, substance consisting essentially of protein, carbohydrate, fat, and other nutrients used in the body of an organism to sustain growth and vital processes and to furnish energy. The absorption and utilization of food by the body is fundamental to nutrition and is facilitated by digestion.</p>
	        </div>
	  </div>
